from commands.RPG.utils.database import ensure_profile, has_selected_class, set_active_hero_class
from discord import Embed, ButtonStyle, Color
from discord.ui import Button, View
from commands.RPG.game.characters.heros import *
...
async def create_hero(inte):
    ...
    class_images = {
        "🧙‍♂️ Mago": MagicDummy().image,
        "🔪 Assassino": AssasinDummy().image,
        "🛡️ Tanque": Tank().image
    }
