from commands.EconomiaRPG.characters.basehero import BaseHero
...
from commands.EconomiaRPG.utils.decorators import mana_ability
...
class EnemyMutanteDoPantanoSimio(BaseHero):
    def __init__(self, **kwargs):
        ...
        self.name = 'Mutante do Pantano SÃ­mio'
