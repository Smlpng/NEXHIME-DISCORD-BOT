...
class Rest(commands.Cog):
    ...
    async def descansar(self, ctx):
        ...
        if hero is None:
            ...
            embed.description = "Seu perfil ainda está sendo preparado."
        ...
        if has_selected_class(inte.user.id):
            ...
            embed.description = (
                ...
                "No sistema atual, vida e mana não ficam persistidas entre combates. "

                "Seu herói já entra pronto para a próxima luta, entao descansar não precisa aplicar cooldown ou recuperar energia."
            ...
            embed.description = (
                ...
                "Seu herói ainda não escolheu uma classe, mas o descanso tambem não e necessario no sistema atual. "

                "Primeiro escolha a classe quando quiser pelo menu do herói."
