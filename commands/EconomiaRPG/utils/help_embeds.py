...
def get_help_embed(command_id: int):
    if command_id == 0: # Introduction
        ...
        embed.add_field(name="/bolsa", value="Resumo rapido da carteira, banco e recursos do heroi. 🎒", inline=False)
        ...
        embed.add_field(name="/venderall", value="Vende todos os recursos comuns do heroi. 📦", inline=False)
        ...
        embed.add_field(name="/slots [aposta]", value="Gira uma maquina caça-niqueis usando nex. 🎰", inline=False)
        ...
        embed.add_field(name="/roleta [aposta] [cor/numero]", value="Aposte em cor ou numero na roleta do cassino. 🎡", inline=False)
        embed.add_field(name="/highlow [aposta] [maior/menor]", value="Adivinhe se a proxima carta sera maior ou menor. 🃏", inline=False)
        embed.add_field(name="/crash [aposta] [multiplicador]", value="Escolha o multiplicador alvo e torca para o grafico nao explodir antes. 📈", inline=False)
        ...
        embed.add_field(name="/lutaarena [jogador] [aposta]", value="Duelo apostado de arena baseado na forca dos herois. ⚔️", inline=False)
