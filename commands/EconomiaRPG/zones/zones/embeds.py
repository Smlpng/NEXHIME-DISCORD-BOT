...
from commands.EconomiaRPG.utils.dex import get_seen_line
...
zones_data = [
    ...
    },
    {
        ...
        "level": "Medio",
        "loot": "Baixo",
        "description": "Um rio feroz corta a mata e atrai predadores de todos os tamanhos. Margens enlameadas, cipÃ³s baixos e rugidos distantes marcam a regiÃ£o.",
    ...
    },
    {
        ...
        "level": "Alto",
        "loot": "Alto",
        "description": "No topo das Ã¡guas escuras e das raÃ­zes gigantes ergue-se a Ãrvore-MÃ£e. Ali se escondem mutaÃ§Ãµes, xamÃ£s e os segredos finais do reino sÃ­mio.",
