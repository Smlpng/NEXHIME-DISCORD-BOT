    ...
    async def daily(self, ctx):
        ...
        if hero is None:
            ...
            return await inte.response.send_message(
                ...
                "Seu perfil economico foi criado, mas você ainda precisa de um herói para resgatar a recompensa diaria."
        ...
        if not claimed:
            ...
            return await inte.response.send_message(
                ...
                f"Você já resgatou seu daily hoje. Tente novamente em {self._format_remaining(remaining)}.",
