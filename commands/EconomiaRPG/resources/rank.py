...
class Rank(commands.Cog):
    ...
    async def rank(self, ctx):
        ...
        if not leaderboard:
            ...
            return await inte.response.send_message("Ainda não ha dados suficientes para gerar o ranking economico.")



        embed = discord.Embed(title="Ranking econômico", color=RPG_PRIMARY_COLOR)
