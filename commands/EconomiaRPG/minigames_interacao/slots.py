...
class Slots(commands.Cog):
    ...
    @commands.command(
        ...
        help="Gira uma máquina caça-níqueis apostando nex. Ex: !slots 500",
    ...
    async def slots(self, ctx: commands.Context, bet_amount: int):
        ...
        if hero is None:
            ...
            return await inte.response.send_message("Não consegui localizar seu herói ativo para usar os slots.")
        ...
        if payout > 0:
            ...
            embed.add_field(
                ...
                value=f"Você ganhou {_format_nex(payout)} nex ({profit:+,} nex).".replace(",", "."),
            ...
            embed.add_field(name="Resultado", value="A casa levou sua aposta destá vez.", inline=False)
