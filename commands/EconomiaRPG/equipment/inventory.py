...
from commands.EconomiaRPG.utils.database import get_active_hero, list_active_inventory
...
from commands.EconomiaRPG.utils.presentation import build_inventory_embed
...
class Inventory(commands.Cog):
    ...
    async def inventory(self, ctx):
        ...
        embed.set_footer(text="Itens marcados como equipados jÃ¡ estÃ£o ativos no seu herÃ³i.")
