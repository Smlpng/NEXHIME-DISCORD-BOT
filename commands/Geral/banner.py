...
class Banner(commands.Cog):
    ...
    @commands.command(name="banner", aliases=["profilebanner"], help="Mostra o banner de um usuário.")
    async def banner(self, ctx: commands.Context, membro: discord.Member | discord.User | None = None):
        ...
        if banner_asset is None and accent_color is None:
            return await ctx.reply("Esse usuário não possui banner nem cor de perfil configurada.")
        ...
        if banner_asset is not None:
            ...
            embed.description = f"Esse usuário não tem banner, mas a cor de perfil dele e {accent_color}."
